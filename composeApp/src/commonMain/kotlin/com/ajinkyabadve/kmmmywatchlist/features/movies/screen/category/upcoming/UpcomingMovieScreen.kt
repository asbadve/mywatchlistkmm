package com.ajinkyabadve.kmmmywatchlist.features.movies.screen.category.upcoming
...
object UpcomingMovieScreen : Tab {
    ...
    override fun Content() {
        ...
        screenContent(getViewModel(UPCOMING_API_PATH), windowSizeClass)
    }
