package com.ajinkyabadve.kmmmywatchlist.features.movies.screen.category.popular
...
object PopularMovieScreen : Tab {
    ...
    override fun Content() {
        ...
        screenContent(getViewModel(POPULAR_API_PATH), windowSizeClass)
    }
