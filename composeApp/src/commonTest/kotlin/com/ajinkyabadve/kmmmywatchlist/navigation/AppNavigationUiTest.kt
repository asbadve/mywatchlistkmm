...
class AppNavigationUiTest {
    ...
    @Test
    fun testAppLaunch_defaultsToTrendingAndNavigationFlow() = runComposeUiTest {
        val fakeTrendingRepository = FakeTrendingRepository().apply {
            getTrendingResult = Result.success(
                MoviePageResult(
                    page = 1,
                    list = listOf(
