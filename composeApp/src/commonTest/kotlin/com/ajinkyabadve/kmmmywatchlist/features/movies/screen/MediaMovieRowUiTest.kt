...
class MediaMovieRowUiTest {
    ...
    @Test
    fun testMediaMovieRow_isLoadingState_displaysShimmerAndNoText() = runComposeUiTest {
        setContent {
            mediaMovieRow(
                imageUrl = null,
                title = "Inception",
    ...
    @Test
    fun testMediaMovieRow_imageUrlNull_displaysFallbackAndTriggersClick() = runComposeUiTest {
        var clicked = false
        setContent {
            mediaMovieRow(
                imageUrl = null,
    ...
    @Test
    fun testMediaMovieRow_imageUrlNotNull_displaysMovieAndTriggersClick() = runComposeUiTest {
        var clicked = false
        setContent {
            mediaMovieRow(
